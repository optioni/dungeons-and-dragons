...
- **THEN** the 10 NPCs with the earliest `nextTickInGameDate` are processed and the remaining 5 retain their current `nextTickInGameDate` for the next tick
