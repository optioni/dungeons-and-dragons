...
1. base system prompt and tool definitions
2. active scene prompt modules
3. campaign state required for play
4. character and world state required for the current scene
...
1. system prompt, tool definitions, and active scene modules
2. campaign state
3. character state, world state, and recent diary context
