# dice-roll-visibility Specification

## Purpose
Persist dice tool results as DICE_ROLL game events and render them as inline roll cards in the transcript, giving players visibility into every skill check, ability check, and dice roll the DM makes during a session.
