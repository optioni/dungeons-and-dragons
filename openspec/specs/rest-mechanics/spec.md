...
Defines how short and long rests are handled — what each restores, how hit dice are spent, and what side effects (diary, world tick, in-game date) a long rest triggers.
