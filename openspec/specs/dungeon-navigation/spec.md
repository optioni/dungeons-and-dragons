# Dungeon Navigation Spec

## Purpose

Defines how the LLM DM enters, traverses, and exits a dungeon — covering the `enter_dungeon`, `move_to_room`, and `exit_dungeon` tools, room connection validation, wandering monster die rolls, and the persistence of `activeDungeonId` across scene type changes.
