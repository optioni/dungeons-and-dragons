...
User authentication for the D&D Solo Adventure App. Covers user registration, login, JWT issuance, global JWT guard with public opt-out, the `@CurrentUser()` decorator, and the `user` database entity.
