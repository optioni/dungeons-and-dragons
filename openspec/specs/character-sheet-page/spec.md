# Capability: Character Sheet Page

## Purpose

Defines requirements for the `/campaign/[id]/character` frontend page, which displays the campaign character's full sheet state outside of a live game session stream.
