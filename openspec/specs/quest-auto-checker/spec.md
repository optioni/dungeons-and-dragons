...
Defines the automatic objective completion system that monitors quest progress by evaluating objectives against the current world state. This spec covers auto-checker scheduling, objective evaluation rules, completion signaling, and query optimization.
