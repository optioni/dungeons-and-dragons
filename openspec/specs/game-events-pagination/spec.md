# game-events-pagination Specification

## Purpose
Defines cursor-based transcript pagination for persisted game events, including the shared relay argument behavior needed to load the newest events first and request older history on demand.
