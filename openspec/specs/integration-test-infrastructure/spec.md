...
## Purpose
Define the API integration test harness for containerized PostgreSQL with pgvector, Redis, migrations, SRD seeding, dynamic test environment propagation, and container cleanup.
