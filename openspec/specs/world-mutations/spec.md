# World Mutations Spec

## Purpose

Defines LLM-driven tools for mutating world state — updating location states, shifting faction dispositions, triggering and resolving world events, updating NPCs, managing party composition, changing scene type, advancing antagonist stages, recording lore, and triggering catastrophes.
