# Player-Visible Mechanical Events

## Purpose

Defines the curated player-visible mechanical event model — the normalized payload shape, the mapping rules, visibility constraints, and the default visibility level. This spec establishes what the player is allowed to know about mechanical consequences and how those consequences are safely surfaced without leaking hidden game state.
