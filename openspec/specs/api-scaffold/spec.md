...
The API scaffold establishes the NestJS backend workspace with GraphQL Yoga, environment configuration, MikroORM (PostgreSQL), BullMQ (Redis), and a Vitest test suite. This is the foundational skeleton all future API modules build upon.
