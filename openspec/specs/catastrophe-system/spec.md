...
Defines how catastrophic world events are triggered probabilistically during world ticks, how the `trigger_catastrophe` tool creates CATASTROPHE-sourced world events, and how these events are surfaced to the player via the DM session context.
