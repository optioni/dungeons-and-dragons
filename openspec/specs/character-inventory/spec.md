...
Defines how items are represented, granted, equipped, and displayed. Covers the Item and CharacterItem entities, equip/unequip mutations, the inventory query, currency tracking, and the web character sheet inventory section.
