...
A Docker Compose configuration at the repository root providing PostgreSQL (with pgvector) and Redis for local development, with setup documentation embedded in the file.
