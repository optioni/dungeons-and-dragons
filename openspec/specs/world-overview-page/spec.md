# Capability: World Overview Page

## Purpose

Defines requirements for the `/campaign/[id]/world` frontend page, which displays campaign world reference information — factions, known NPCs, diary entries, and active world events — outside of the live game session stream.
