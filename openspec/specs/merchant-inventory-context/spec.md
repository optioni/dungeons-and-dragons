# Merchant Inventory Context Spec

## Purpose

Defines how NPC merchant inventory is queried and injected into the DM turn prompt context, enabling the LLM to reference merchant stock during play.
