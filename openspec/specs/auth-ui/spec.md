...
Frontend authentication UI for the D&D Solo Adventure App. Covers the `/auth` page with login and registration forms, JWT cookie storage, urql client configuration for cookie-based auth, and middleware-based redirect logic.
