# Encounter Monster Draw Spec

## Purpose

Defines how the system selects monsters for triggered encounters based on the player character's level and challenge rating brackets.
