...
Defines the death-save UI that appears when the player character drops to 0 HP — how it surfaces in the play shell, how it displays current success/failure progress, and how it coexists with other active play-state UI such as the combat panel and transcript.
