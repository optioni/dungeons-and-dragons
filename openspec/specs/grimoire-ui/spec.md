...
Defines the Dark Grimoire visual design system for the web app — colour tokens, typography rules, global background treatment, animation keyframes, and component-level requirements for every screen in the campaign section. The goal is a cohesive aged-parchment / dark-fantasy aesthetic that replaces generic Tailwind/Nuxt UI defaults.
